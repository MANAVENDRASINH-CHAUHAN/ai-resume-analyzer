<?php $__env->startSection('title', 'Welcome ' . ($user->name ?? 'User')); ?>

<?php $__env->startSection('content'); ?>
    <div data-candidate-dashboard data-stats-url="<?php echo e(route('user.dashboard.stats')); ?>">
    ...
    <div class="dashboard-card mb-4">
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-4 text-lg-end">
                <a href="<?php echo e(route('user.resumes.create')); ?>" class="btn btn-primary rounded-pill px-4 me-2 mb-2 mb-lg-0">Upload Resume</a>
                <a href="<?php echo e(route('user.resumes.index')); ?>" class="btn btn-outline-dark rounded-pill px-4">My Resumes</a>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="stat-card h-100">
                ...
                <div class="stat-value" data-dashboard-stat="average_score"><?php echo e($averageScore ?? 0); ?>%</div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="dashboard-card h-100">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                    ...
                    <a href="<?php echo e(route('user.resumes.index')); ?>" class="badge text-bg-light border text-decoration-none">View all</a>
                </div>
                <div class="table-responsive">
                    <table class="table dashboard-table align-middle mb-0">
                        ...
                        <tbody data-dashboard-recent-resumes>
                            <?php $__empty_1 = true; $__currentLoopData = ($recentResumes ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resume): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <a href="<?php echo e(route('user.resumes.show', $resume)); ?>" class="fw-semibold text-dark">
                                            <?php echo e($resume->file_name); ?>
                                    ...
                                    <td>
                                        <span class="badge rounded-pill <?php echo e($resume->analysis_status_badge_class); ?>">
                                            <?php echo e(str($resume->analysis_status ?? 'pending')->replace('_', ' ')->title()); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e($resume->resumeScore->total_score ?? 0); ?>%</td>
        ...
        <div class="col-lg-4">
            <div class="dashboard-card h-100">
                ...
                <div class="d-grid gap-3">
                    <a href="<?php echo e(route('user.resumes.create')); ?>" class="quick-action-card">
                    ...
                    <a href="<?php echo e(route('user.resumes.index')); ?>" class="quick-action-card">
                    ...
                    <a href="<?php echo e(route('user.reports.index')); ?>" class="quick-action-card">
                    ...
                    <a href="<?php echo e(route('user.profile')); ?>" class="quick-action-card">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/manavendrasinh/Desktop/ai_resume_analyzer/resources/views/user/dashboard.blade.php ENDPATH**/ ?>